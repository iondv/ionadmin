...
var restURL = serverURL + '/ionadmin/models/municipal/create';
var TestMunTitle = 'test';
var CreateMun = function (done) {
  describe.skip('# Проверяем доступность страницы Создать муниципальное образование', function () {
  ...
  describe.skip('Создание Муниципального образования', function () {
    ...
    it('Заполнение поля Заголовок и Сохранение результата', function () {
      element(by.xpath('//*[@id="obj-name"]')).sendKeys(TestMunTitle);
      element(by.xpath('//*[@id="save-form"]')).click();
      browser.sleep(testConfig.browser.eachSleep);
...
module.exports.CreateMun = CreateMun;
