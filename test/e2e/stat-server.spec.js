// Тестирование меню статистики сервера
/**
 * Настройки теста
 * */
...
var restURL = serverURL + '/ionadmin/stat/server';

describe.skip('# Проверяем доступность страницы Использование сервера', function () {
  it ('Ожидаем прогрузку страницы', function () {
    expect(testObj.get(restURL)).to.eventually.equal(restURL);
  });
  describe('# Проверяем загрузку страницы Использование сервера', function () {
