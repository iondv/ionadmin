...
var restURL = serverURL + '/ionadmin/models/postCategory/create';
var TestImg = './modules/ionadmin/src/demo-photos/img1.jpg';
var TestImgTitle = 'test';
var CreatePostCat = function (done) {
  describe.skip('Проверяем доступность страницы Создать категорию новости', function () {
  ...
  describe.skip('# Создание тестовой категорию новости', function () {
    ...
    it('Заполнение поля Заголовок и Сохранение результата', function () {
      element(by.xpath('//*[@id="obj-name"]')).sendKeys(TestImgTitle);
      element(by.xpath('//*[@id="save-form"]')).click();
      browser.sleep(testConfig.browser.eachSleep);
...
module.exports.CreatePostCat = CreatePostCat;
