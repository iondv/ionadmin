// Тестирование меню категории новостей
/**
 * Настройки теста
 * */
...
var CreatePostCat = require ('./models-postCategory-create.js').CreatePostCat;
var EditPostCat = require ('./models-postCategory-ID.js').EditPostCat;
var idTest;
var TestImgTitle = 'testEDIT';

describe.skip('# Проверяем доступность страницы Категории новостей', function () {
  it ('Ожидаем прогрузку страницы', function () {
    expect(testObj.get(restURL)).to.eventually.equal(restURL);
  });
  describe('Проверяем загрузку страницы Категории новостей', function () {
  ...
  describe('Проверяем функциональные кнопки', function () {
    it('Проверка загрузки страницы Создать категорию новости', function (done) {
      CreatePostCat(done);
      describe('Проверяем Редактирование', function () {
        it('Проверка кнопки Править, правка тестового объекта', function (done) {
          ...
          describe('Проверяем поиск по списку объектов и удаление тестового объекта', function () {
            ...
            it('Удаление тестовой Категории новостей', function () {
