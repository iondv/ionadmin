...
describe.skip('# Проверяем доступность страницы контрольной панели', function () {
  it('Загрузка страницы', function () {
    testObj.resizeWindow().then(function (size) {
      console.log('Ширина экрана: ' + size.width + 'px');
    });
    expect(testObj.get(restURL)).to.eventually.equal(restURL, 'url не совпадает с ' + restURL);
    expect(testObj.getTitle()).to.eventually.equal(testConfig.title, 'Открыт не ' + testConfig.title);
  });
  describe('Проверяем загрузку страницы контрольной панели', function () {
    ...
    it ('Загружаются все ключевые JS', function (done) {
      var results = [];
  ...
  describe('Проверяем статистику на контрольной панели', function () {
    it ('Проверка прорисовки меню статистики', function () {
      ...
      element(by.xpath('/html/body/div[1]/aside/section/ul/li[5]/ul')).waitElementReady();
  ...
  describe('Проверяем модели данных на контрольной панели', function () {
    it ('Проверка прорисовки меню моделей', function () {
      ...
      element(by.xpath('/html/body/div[1]/aside/section/ul/li[6]/ul')).waitElementReady();
  ...
  describe('Проверяем Статистику сервера на контрольной панели', function () {
    it('Проверка элемента Date range', function () {
      element(by.xpath('//*[@id="server-date"]')).click();
      element(by.xpath('/html/body/div[2]')).isDisplayed().then(function (res) {
        expect(res).to.be.true;
      });
    });
    it('Проверка сворачивания элемента', function () {
      element(by.xpath('/html/body/div[1]/div/section[2]/div/section[1]/div/div[1]/div/button[1]')).click();
      browser.sleep(1000);
      element(by.xpath('/html/body/div[1]/div/section[2]/div/section[1]/div/div[2]'))
        .isDisplayed().then(function (res) {
        expect(res).to.be.false;
      });
    });
  });
  describe('Проверяем Статистику посещений на контрольной панели', function () {
    it('Проверка элемента Date range', function () {
      element(by.xpath('//*[@id="visitors-daterange"]')).click();
      element(by.xpath('/html/body/div[3]')).isDisplayed().then(function (res) {
        expect(res).to.be.true;
      });
    });
    it('Проверка сворачивания элемента', function () {
      element(by.xpath('/html/body/div[1]/div/section[2]/div/section[2]/div[1]/div[1]/div/button[1]')).click();
      browser.sleep(1000);
      element(by.xpath('/html/body/div[1]/div/section[2]/div/section[2]/div[1]/div[2]'))
        .isDisplayed().then(function (res) {
          expect(res).to.be.false;
        });
    });
  });
  describe('Проверяем Используемые браузеры на контрольной панели', function () {
    it('Проверка сворачивания элемента', function () {
      element(by.xpath('/html/body/div[1]/div/section[2]/div/section[2]/div[3]/div[1]/div/button[1]')).click();
      browser.sleep(testConfig.browser.eachSleep);
      element(by.xpath('/html/body/div[1]/div/section[2]/div/section[2]/div[3]/div[2]'))
        .isDisplayed().then(function (res) {
          expect(res).to.be.false;
        });
    });
  ...
  describe('Проверяем удаление элементов статистики на контрольной панели', function () {
      it('Проверка кнопки удалить у Статистики сервера', function () {
        element(by.xpath('/html/body/div[1]/div/section[2]/div/section[1]/div/div[1]/div/button[2]')).click();
        browser.sleep(testConfig.browser.eachSleep);
        element(by.xpath('/html/body/div[1]/div/section[2]/div/section[1]/div'))
          .isDisplayed().then(function (res) {
            expect(res).to.be.false;
          });
      });
      it('Проверка кнопки удалить у Статистики посещений', function () {
        element(by.xpath('/html/body/div[1]/div/section[2]/div/section[2]/div[1]/div[1]/div/button[2]')).click();
        browser.sleep(testConfig.browser.eachSleep);
        element(by.xpath('/html/body/div[1]/div/section[2]/div/section[2]/div[1]'))
          .isDisplayed().then(function (res) {
            expect(res).to.be.false;
          });
      });
      it('Проверка кнопки удалить у Используемых браузеров', function () {
        element(by.xpath('/html/body/div[1]/div/section[2]/div/section[2]/div[3]/div[1]/div/button[2]')).click();
        browser.sleep(testConfig.browser.eachSleep);
        element(by.xpath('/html/body/div[1]/div/section[2]/div/section[2]/div[3]'))
          .isDisplayed().then(function (res) {
            expect(res).to.be.false;
          });
      });
