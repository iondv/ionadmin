...
var restURLC = serverURL + '/ionadmin/models/post/create';
var TestPostTitle = 'teststring';
var CreatePost = function (done) {
  describe.skip('# Проверяем доступность страницы Создать новость', function () {
  it ('Ожидаем прогрузку страницы', function () {
    expect(testObj.get(restURLC)).to.eventually.equal(restURLC);
  });
  describe.skip('Проверяем загрузку страницы Создать категорию новости', function () {
  ...
  describe.skip('Создание тестовой новости', function () {
    it ('Заполнение поля Публиковать', function () {
    ...
    it('Заполнение поля Важная новость', function () {
    ...
    it('Заполнение поля Показать на главной', function () {
    ...
    it('Заполнение поля Тип новости', function () {
    ...
    it('Заполнение поля Дата', function () {
      element(by.xpath('//*[@id="object-form"]/div/div[5]/div/div/input[2]')).click();
      element(by.xpath('/html/body/div[2]/div[1]/table')).all(by.css('td.new.day')).get(0).click();
      element(by.xpath('//*[@id="obj-date"]')).getAttribute('value').then(function (res) {
        expect(res).to.not.be.empty;
      });
    });
    it('Заполнение поля Заголовок', function () {
      element(by.xpath('//*[@id="obj-title"]')).sendKeys(TestPostTitle);
      element(by.xpath('//*[@id="obj-title"]')).getAttribute('value').then(function (res) {
        expect(res).to.be.equal(TestPostTitle);
      });
    });
    it('Заполнение поля Подзаголовок', function () {
      element(by.xpath('//*[@id="obj-subtitle"]')).sendKeys(TestPostTitle);
      element(by.xpath('//*[@id="obj-subtitle"]')).getAttribute('value').then(function (res) {
        expect(res).to.be.equal(TestPostTitle);
      });
    });
    it('Заполнение поля Текст новости', function () {
      browser.switchTo().frame(0);
      element(by.xpath('/html/body')).sendKeys(TestPostTitle);
      element(by.xpath('/html/body')).getText().then(function (res) {
        expect(res).to.be.equal(TestPostTitle);
      });
      browser.switchTo().defaultContent();
    });
    it('Заполнение поля Главное фото', function (done) {
      ...
      browser.getAllWindowHandles().then(function (res) {
        ...
        element(by.className('dataTables_empty')).isPresent().then(function (result) {
          if (result) { console.log('Отсутствуют данные в таблице Изображения');
    ...
    it('Заполнение поля Фотосессия', function (done) {
      ...
      browser.getAllWindowHandles().then(function (res) {
        ...
        element(by.className('dataTables_empty')).isPresent().then(function (result) {
          ...
          } else { element(by.xpath('//*[@id="object-list"]/tbody')).all(by.tagName('tr')).get(0).click();
            element(by.xpath('//*[@id="select-btn"]')).click();
            browser.switchTo().window(res[0]);
            browser.switchTo().activeElement();
    ...
    it('Заполнение поля Категории', function (done) {
      ...
      browser.getAllWindowHandles().then(function (res) {
        ...
        element(by.className('dataTables_empty')).isPresent().then(function (result) {
          if (result) { console.log('Отсутствуют данные в таблице Категории новостей');
            // Переключаемся на старую вкладку
            browser.close();
            browser.switchTo().window(res[0]);
            browser.switchTo().activeElement();
    ...
    it('Заполнение поля Должностные лица', function (done) {
      ...
      browser.getAllWindowHandles().then(function (res) {
        ...
        element(by.className('dataTables_empty')).isPresent().then(function (result) {
          if (result) { console.log('Отсутствуют данные в таблице Должностные лица');
            // Переключаемся на старую вкладку
            browser.close();
            browser.switchTo().window(res[0]);
            browser.switchTo().activeElement();
    ...
    it('Заполнение поля Ответственные лица', function (done) {
    ...
    it('Заполнение поля Муниципальные образования', function (done) {
      ...
      browser.getAllWindowHandles().then(function (res) {
        ...
        element(by.className('dataTables_empty')).isPresent().then(function (result) {
          if (result) { console.log('Отсутствуют данные в таблице Муниципальные образования');
            // Переключаемся на старую вкладку
            browser.close();
            browser.switchTo().window(res[0]);
            browser.switchTo().activeElement();
    ...
    it('Заполнение поля Связанные новости', function (done) {
