// Тестирование меню типов новостей
/**
 * Настройки теста
 * */
...
var idTest;
var TestPostType = 'testedit';
var CreatePostType = require ('./models-PostType-create.js').CreatePostType;
var EditPostType = require ('./models-PostType-ID.js').EditPostType;

describe.skip('# Проверяем доступность страницы Типы новостей', function () {
  it ('Ожидаем прогрузку страницы', function () {
    expect(testObj.get(restURL)).to.eventually.equal(restURL);
  });
  describe('Проверяем загрузку страницы Типы новостей', function () {
  ...
  describe('Проверяем функциональные кнопки', function () {
    it('Проверка загрузки страницы Создать Тип новости', function (done) {
      CreatePostType(done);
      describe('Проверяем Редактирование', function () {
        it('Проверка кнопки Править, правка тестового объекта', function (done) {
          ...
          describe('Проверяем поиск по списку объектов и Удаление тестового объекта', function () {
            ...
            it('Удаление нового Типа новости', function () {
